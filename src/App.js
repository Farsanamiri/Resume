    ...
    <div className="background-container">
      ...
      <div className="App">
        ...
        <div className="fullpage">
          ...
          <div className="scroll-button" onClick={scrollToBoxes}>
        ...
        <div className="scroll-button-2" onClick={scrollToBoxest}>
          <div className="arrow-animation">⬇</div>
        </div>
        ...
        <div className="scroll-button-2" onClick={scrollToBoxesth}>
          <div className="arrow-animation">⬇</div>
        </div>
